...
+ [High-Accuracy Stereo Depth Maps Using Structured Light](https://web.archive.org/web/20060903112133/http://community.middlebury.edu/~schar/papers/structlight/structlight.pdf)
    + stereo algorithms, in particular determining correspondence between view and illumination patterns
...
+ [2012_micro_phase_shifting](2012_micro_phase_shifting.pdf)
    ...
    + phase shifting
        + need some more background on phase shifting
...
+ [2004_pixel_recovery_via_l1_minimization_in_the_wavelet_domain](2004_pixel_recovery_via_l1_minimization_in_the_wavelet_domain.pdf)
    + problem
