...
\begin{figure}[h!]
    ...
    \end{center}
    \caption{Here we have spatial sinusoids with period 1,2,5,17,31, each shifted 30 times projected onto a static scene. Resulting in $5\cdot 30=150$ measurement, each stacked from at least 100 noisy images. We see ZNCC decoding taking 3,5,7,10,12,15,50,150 randomly chosen measurements respectively yield progressively better disparity reconstruction}
